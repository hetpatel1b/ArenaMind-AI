...
interface CrowdPersistentCopilotProps {
  scenarioContext: {
    stadiumName: string;
    phase: string;
    maxDensity: number;
        ...
        {isOpen && (
          ...
          >
            ...
            <div style={{ padding: 'var(--space-4)', backgroundColor: 'rgba(10, 132, 255, 0.05)' }}>
              ...
              >
                Active Crowd Context
              </div>
              <div style={{ fontSize: 'var(--text-sm)', color: 'var(--ai-accent)' }}>
                {scenarioContext.stadiumName} • {scenarioContext.phase.replace('_', ' ')}
              </div>
              <div
                style={{
              ...
              >
                Highest Risk: {scenarioContext.highestRiskZoneName} (
                {scenarioContext.maxDensity.toFixed(1)}% Saturation)
              </div>
            </div>
            ...
            >
              ...
              >
                <input
                  ...
                  placeholder="Ask about crowd dynamics..."
                  style={{
                    flex: 1,
                    background: 'none',
                    border: 'none',
