              ...
              {['light', 'dark', 'system'].map((t) => (
                <button
                  ...
                  style={{
                    textAlign: 'left',
                    padding: 'var(--space-2)',
                    background: state.theme === t ? 'rgba(255,255,255,0.05)' : 'transparent',
                    border: 'none',
                    color: state.theme === t ? 'var(--text-primary)' : 'var(--text-secondary)',
                  ...
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.background =
                      state.theme === t ? 'rgba(255,255,255,0.05)' : 'transparent')
                  }
                >
                  {t}
                </button>
