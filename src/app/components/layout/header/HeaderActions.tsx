  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <AnimatePresence>
          {isHelpMenuOpen && (
            <FocusTrap active={isHelpMenuOpen} onEscape={() => setIsHelpMenuOpen(false)}>
              <motion.div
                id="help-menu"
              ...
              >
                ...
                {['Quick Docs', 'Keyboard Shortcuts', 'Support Center', 'Give Feedback'].map(
                  (t) => (
                    <button
                      key={t}
                      onClick={() => {
      ...
      <div style={{ position: 'relative' }}>
        ...
        <AnimatePresence>
          {isAppLauncherOpen && (
            <FocusTrap active={isAppLauncherOpen} onEscape={() => setIsAppLauncherOpen(false)}>
              <motion.div
