          ...
          <FocusTrap active={isOpen} onEscape={onClose}>
            ...
            >
              <div id={descId} className="sr-only" style={{ display: 'none' }}>
                Manage workspace preferences, appearance, and accessibility settings.
              </div>
              {/* Sidebar */}
              <div
                style={{
              ...
              >
                ...
                >
                  <h2
                    style={{ margin: 0, fontSize: 'var(--text-lg)', textTransform: 'capitalize' }}
                  >
                    {activeTab.replace('-', ' ')}
                  </h2>
                  <button
                  ...
                  {activeTab === 'appearance' && (
                    ...
                    >
                      <div>
                        ...
                        >
                          Select your default workspace theme. Dark mode is recommended for
                  ...
                  {activeTab === 'accessibility' && (
                    ...
                    >
                      ...
                      >
                        <div>
                          <h3
                            style={{ margin: '0 0 var(--space-1) 0', fontSize: 'var(--text-md)' }}
                          >
                            Reduced Motion
                          </h3>
                          <p
