                ...
                <div style={{ display: 'flex', gap: 'var(--space-2)' }}>
                  ...
                  >
                    ...
                    >
                      ...
                      suggest proactively rerouting the Downtown Shuttle Loop to avoid the North
                      Metro corridor bottleneck.
                    </p>
                    <div
                      style={{
                        display: 'flex',
                    ...
                    >
                      <button
                        onClick={() => sendMessage('Calculate alternate route ETA')}
                        style={{
                          backgroundColor: 'rgba(255,255,255,0.05)',
                      ...
                      <button
                        onClick={() => sendMessage('Draft reroute directive')}
                        style={{
                          backgroundColor: 'rgba(255,255,255,0.05)',
                          border: '1px solid rgba(255,255,255,0.1)',
                          color: 'var(--text-secondary)',
